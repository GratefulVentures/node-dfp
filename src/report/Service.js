...
export default class ReportService extends Service {
    ...
    runReportJob(reportJob) {
        ...
        return this.callAsync('runReportJob', { reportJob })
            .then(resp => new ReportJob(resp.id, resp.reportQuery, resp.reportJobStatus))
    }
        ...
        return this.checkStatus(reportJob)
            ...
            .then(() => {
                ...
                return new Promise(function (resolve, reject) {
                    setTimeout(function () {
                        service.waitForJob(reportJob, pollInterval)
                            .then(resolve, reject)
                    }, pollInterval)
                })
            })
    ...
    download(report, exportFormat = ExportFormat.CSV_DUMP) {
        return this.getDownloadURL(report, exportFormat)
            .then(url => {
